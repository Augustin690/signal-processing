...
repimages='/Users/said/SVN/said_serveur/Enseignement/OASIS/TPs/TP3_Image/donnees/' # A ADAPTER
a=np.float32(skio.imread(repimages+'lena512.gif'))
affiche(a)
...
def defloute(re):
    ...
    h=np.random.rand(3,3) #ATTENTION C'EST FAUX (voir question Q5.1)
